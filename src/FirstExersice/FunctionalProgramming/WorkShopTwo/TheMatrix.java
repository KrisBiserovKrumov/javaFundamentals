...
public class TheMatrix {
    ...
    public static char toBeReplace;
    public static void main(String[] args) throws IOException {
        ...
        for (int r = 0; r <  rows; r++) {
            matrix[r] = reader.readLine().replaceAll(" +", "")
                    .toCharArray();
        }
        ...
        toBeReplace = matrix[startRow][startCol];
    ...
    private static void paintMatrix(int r, int c) {
        if (!isInBounds(r,c) || matrix[r][c] == color || matrix[r][c]  != toBeReplace){
            return;
